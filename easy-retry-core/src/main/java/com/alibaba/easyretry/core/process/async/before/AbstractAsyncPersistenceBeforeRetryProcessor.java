...
public abstract class AbstractAsyncPersistenceBeforeRetryProcessor<R> extends
	...
	public void doProcess() {
		...
		retryTask.setRecoverMethod(retryerInfo.getRecoverMethod());
		retryTask.setResultCondition(retryerInfo.getResultCondition());
		retryTask.setGmtCreate(new Date());
		retryTask.setGmtModified(new Date());
		retryTask.setExtAttrs(Maps.newHashMap());
